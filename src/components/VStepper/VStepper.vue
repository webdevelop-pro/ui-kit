  ...
  <div class="VStepper v-stepper">
    ...
    >
      <slot
        ...
        :step="step"
      >
        <div class="v-stepper__step-point">
          <div class="v-stepper__circle">
            <VSvgIcon
              v-if="modelValue > index"
              name="check"
              class="v-stepper__check-icon"
            />
          </div>
        </div>
        <div class="v-stepper__label">
          <span class="v-stepper__label-step is--small">
            Step {{ index + 1 }}
          </span>
          <span class="v-stepper__label-title is--h5__title">
            {{ step.title }}
          </span>
        </div>
      </slot>
