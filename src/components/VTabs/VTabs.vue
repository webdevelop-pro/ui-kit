...
const emit = defineEmits<{
  (e: 'update:modelValue', value: ITab['value']): void;
  (e: 'itemClick', value: ITab): void;
  (e: 'setUrl', value: string | number): void;
}>();

function onItemClick(tab: ITab) {
...
<template>
  ...
  >
    ...
    >
      ...
      >
        <span
          class="v-tabs__item-label is--h5__title"
          :title="tab.label"
        >
          {{ tab.label }}
        </span>
